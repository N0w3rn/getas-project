<template>
  <PageWrapper
    :help-content="$t('hedgehog.maggots.content')"
    :sources="sources"
  >
    <InteractiveImage 
      background-image="/images/bg/maggots-background.jpg"
      :markers="doveMarker"
      fill-viewport
...
const doveMarker = [
  {
    id: 'maggots',
    link: '/subside/hedgehog-day-walking',
    image: '/images/sides/maggots.gif',
    x: 38,
    y: 70,
    size: 400,
    label: false
